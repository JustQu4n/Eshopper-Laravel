          ...
          <tbody>
            <tr>
              ...
              <?php 
                ...
                {
                  ?>
                    <a href="{{URL::to('/unactive-brand-product/'.$item->brand_id)}}" ><span class="fa fa-thumbs-down" style="color:red;"></span>
                      <?php
                }  else{
                  ?>
                  <a href="{{URL::to('/active-brand-product/'.$item->brand_id)}}"><span class="fa fa-thumbs-up" style="color:green;"></span>
                    <?php
                  }
                  ?>
              ...
              <td>
                <a href="{{URL::to('edit-brand-product/'.$item->brand_id)}}" class="active" ui-toggle-class="">
                 ...
                 <a  onclick="return confirm('Are you sure to delete?')" href="{{URL::to('delete-brand-product/'.$item->brand_id)}}" > <i class="fa fa-times text-danger text"></i>
                </a>
              </td>
            </tr>
            @endforeach
